#ifndef XJOS_NET_ARP_H
#define XJOS_NET_ARP_H
...
#define ARP_ENTRY_TIMEOUT 600   // ARP 表项超时时间，单位为秒
#define ARP_RETRY 5             // ARP 重试次数
#define ARP_DELAY 2             // ARP 延迟时间，单位为秒
#define ARP_REFRESH_DELAY 1000  // ARP 刷新延迟，单位为毫秒
